...
from .models import Coupon, Item, Order, OrderItem, Address, Payment, Refund, UserProfile
...
class CheckoutView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            order = Order.objects.get(user=self.request.user, ordered=False)
            if form.is_valid():
                use_default_shipping = form.cleaned_data.get('street_address')
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            amount = int(order.get_total() * 100)  # cent
            ...
            except stripe.error.RageLimitError as e:
            ...
            except stripe.error.AuthenticationsError as e:
